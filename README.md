...
This API provides JSON endpoints for accessing an extensive kanji dictionary with information on over 13,000 kanji.

Learn more about Kanji Data API at [kanjiapi.dev](https://kanjiapi.dev).
