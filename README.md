...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kanji-data` | `npm install @voxgig-sdk/kanji-data` |
| Python | `voxgig-sdk-kanji-data` | `pip install voxgig-sdk-kanji-data` |
| PHP | `voxgig-sdk/kanji-data` | `composer require voxgig-sdk/kanji-data` |
| Golang | `github.com/voxgig-sdk/kanji-data-sdk/go` | `go get github.com/voxgig-sdk/kanji-data-sdk/go` |
| Ruby | `voxgig-sdk-kanji-data` | `gem install voxgig-sdk-kanji-data` |
| Lua | `voxgig-sdk-kanji-data` | `luarocks install voxgig-sdk-kanji-data` |
