# KanjiData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KanjiDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KanjiDataSDK(...) and KanjiDataSDK.test(...) become
#      KanjiDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kanjidata_sdk"
_SDK_CLASS = "KanjiDataSDK"
