...
class KanjiDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KanjiDataTestRunner.getenv("KANJIDATA_TEST_LIVE")
        override = KanjiDataTestRunner.getenv("KANJIDATA_TEST_OVERRIDE")
        ...
        explain = KanjiDataTestRunner.getenv("KANJIDATA_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["KANJIDATA_TEST_EXPLAIN"] = explain
