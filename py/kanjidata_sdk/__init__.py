...
from kanjidata_sdk.utility import register

# Load features
from kanjidata_sdk.feature.base_feature import KanjiDataBaseFeature
from kanjidata_sdk.features import _has_feature, _make_feature
...
class KanjiDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KanjiDataUtility()
        self._utility = utility

        from kanjidata_sdk.config import shared_config
    ...
    def get_utility(self):
        return KanjiDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KanjiDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Kanji(self, data=None) -> "KanjiEntity":
        ...
        from kanjidata_sdk.entity.kanji_entity import KanjiEntity
    ...
    def Reading(self, data=None) -> "ReadingEntity":
        ...
        from kanjidata_sdk.entity.reading_entity import ReadingEntity
        return ReadingEntity(self, data)


    def Word(self, data=None) -> "WordEntity":
        """Entity factory: client.Word().list() / client.Word().load({"id": ...})."""
        from kanjidata_sdk.entity.word_entity import WordEntity
