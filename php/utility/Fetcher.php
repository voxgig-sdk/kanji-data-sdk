...
class KanjiDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KanjiDataSDK/1.0)';
    ...
    public static function call(KanjiDataContext $ctx, string $fullurl, array $fetchdef): array
    {
