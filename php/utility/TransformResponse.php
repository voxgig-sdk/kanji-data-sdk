...
// KanjiData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KanjiDataTransformResponse
{
    public static function call(KanjiDataContext $ctx): mixed
    {
        ...
        $transform = KanjiDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
