...
class KanjiDataGraphql
{
    ...
    // equivalent.
    public static function body(KanjiDataContext $ctx): mixed
    {
    ...
    public static function errors(KanjiDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
