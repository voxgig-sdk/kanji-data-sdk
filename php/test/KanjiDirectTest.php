...
class KanjiDirectTest extends TestCase
{
    public function test_direct_load_kanji(): void
    {
        $setup = kanji_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-kanji", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
