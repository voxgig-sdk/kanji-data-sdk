...
// KanjiData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KanjiDataSDK::test)
...
{
    private const SDK_CLASS = 'KanjiDataSDK';
    ...
    private const SDK_BASE = 'kanjidata_sdk';
