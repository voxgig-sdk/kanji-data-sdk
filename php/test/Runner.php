...
class KanjiDataTestRunner
{
    ...
    {
        $live = self::getenv('KANJI_DATA_TEST_LIVE');
        $override = self::getenv('KANJI_DATA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('KANJI_DATA_TEST_EXPLAIN');
...
class_alias('KanjiDataTestRunner', 'Runner');
class_alias('KanjiDataHelpers', 'Helpers');
