...
class ReadingDirectTest extends TestCase
{
    public function test_direct_load_reading(): void
    {
        $setup = reading_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-reading", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
