...
class KanjiDataCacheFeature extends KanjiDataBaseFeature
{
    ...
    private function _through(KanjiDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
