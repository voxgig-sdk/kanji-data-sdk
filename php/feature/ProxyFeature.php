...
class KanjiDataProxyFeature extends KanjiDataBaseFeature
{
    ...
    public function init(KanjiDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KanjiDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
