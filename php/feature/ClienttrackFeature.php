...
// KanjiData SDK clienttrack feature
...
class KanjiDataClienttrackFeature extends KanjiDataBaseFeature
{
    ...
    public function PostConstruct(KanjiDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KanjiData-SDK';
