...
class KanjiDataTimeoutFeature extends KanjiDataBaseFeature
{
    ...
    private function _with_timeout(KanjiDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KanjiDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
