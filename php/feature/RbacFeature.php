...
class KanjiDataRbacFeature extends KanjiDataBaseFeature
{
    ...
    private function _required(KanjiDataContext $ctx): ?string
    {
    ...
    private function _reject(KanjiDataContext $ctx, string $required): void
    {
    ...
    private function _track(KanjiDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
