...
The PHP SDK for the KanjiData API — an entity-oriented client using PHP conventions.
...
```
php/
├── kanjidata_sdk.php          -- Main SDK class
...
The main class (`kanjidata_sdk.php`) exports the SDK class
