...
The PHP SDK for the KanjiData API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Kanji(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->KanjiData(null)->load(
    ["id" => "test01"], null
);
