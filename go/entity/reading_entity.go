...
func NewReadingEntity(client *core.KanjiDataSDK, entopts map[string]any) *ReadingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReadingEntity) GetName() string { return e.name }
...
func (e *ReadingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReadingEntity) Deleted() bool {
	return e.deleted
}


func (e *ReadingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReadingEntity(e.client, opts)
}

func (e *ReadingEntity) Data(args ...any) any {
...
func (e *ReadingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reading; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReadingEntity) DataTyped(data ...Reading) Reading {
	if len(data) > 0 {
		return typedFrom[Reading](e.Data(asMap(data[0])))
	}
	return typedFrom[Reading](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reading (all fields
// optional at the wire level).
func (e *ReadingEntity) MatchTyped(match ...Reading) Reading {
	if len(match) > 0 {
		return typedFrom[Reading](e.Match(asMap(match[0])))
	}
	return typedFrom[Reading](e.Match())
}
...
func (e *ReadingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReadingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReadingLoadMatch and returns an Reading. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReadingEntity) LoadTyped(reqmatch ReadingLoadMatch, ctrl map[string]any) (Reading, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Reading{}, err
	}
	return typedFrom[Reading](res), nil
}



func (e *ReadingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReadingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReadingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReadingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReadingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
