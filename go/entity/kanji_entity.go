...
func NewKanjiEntity(client *core.KanjiDataSDK, entopts map[string]any) *KanjiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KanjiEntity) GetName() string { return e.name }
...
func (e *KanjiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KanjiEntity) Deleted() bool {
	return e.deleted
}


func (e *KanjiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKanjiEntity(e.client, opts)
}

func (e *KanjiEntity) Data(args ...any) any {
...
func (e *KanjiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *KanjiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KanjiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *KanjiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *KanjiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *KanjiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KanjiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
