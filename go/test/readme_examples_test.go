...
const testSeed = `map[string]any{"entity": map[string]any{"kanji": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reading": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "word": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
