...
// KanjiData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KanjiDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KanjiDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(KanjiDataOmni::structfix($val, Struct::undef()))) {
