...
// KanjiData SDK streaming feature
...
class KanjiDataStreamingFeature extends KanjiDataBaseFeature
{
    ...
    private function _iterate(KanjiDataResult $result): \Generator
    {
    ...
    private function _streamable(KanjiDataContext $ctx): bool
    {
