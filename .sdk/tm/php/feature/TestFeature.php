...
// KanjiData SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KanjiDataTestFeature extends KanjiDataBaseFeature
{
    ...
    public function init(KanjiDataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KanjiDataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KanjiDataParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KanjiDataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KanjiDataContext $ctx, $op, $args): array
    {
