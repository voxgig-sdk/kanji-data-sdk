...
// KanjiData SDK ratelimit feature
...
class KanjiDataRatelimitFeature extends KanjiDataBaseFeature
{
    ...
    private function _acquire(KanjiDataContext $ctx): void
    {
    ...
    private function _track(KanjiDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
