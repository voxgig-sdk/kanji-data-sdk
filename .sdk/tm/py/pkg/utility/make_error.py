# KanjiData SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, KanjiDataError):
        errmsg = err.msg
    ...
    msg = "KanjiDataSDK: " + opname + ": " + errmsg
    ...
    sdk_err = KanjiDataError("", msg, ctx)
