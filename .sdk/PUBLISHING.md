...
|---|---|---|
| `ts/` | @voxgig-sdk/kanji-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kanji-data-sdk \
      --repository voxgig-sdk/kanji-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kanji-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kanji-data-sdk --id=<id>` removes it.
