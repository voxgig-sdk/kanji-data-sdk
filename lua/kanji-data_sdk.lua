...
local KanjiDataSDK = {}
KanjiDataSDK.__index = KanjiDataSDK
...
KanjiDataSDK._make_feature = _make_feature


function KanjiDataSDK.new(options)
  local self = setmetatable({}, KanjiDataSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KanjiDataSDK:options_map()
...
function KanjiDataSDK:get_utility()
  return Utility.copy(self._utility)
end


function KanjiDataSDK:get_root_ctx()
  return self._rootctx
end


function KanjiDataSDK:prepare(fetchargs)
...
function KanjiDataSDK:direct(fetchargs)
...
-- by passing it.
function KanjiDataSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KanjiDataSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KanjiDataSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KanjiDataSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KanjiDataSDK.new(sdkopts)
  sdk.mode = "test"
