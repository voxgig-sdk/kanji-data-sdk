...
describe("ReadingDirect", function()
  it("should direct-load-reading", function()
    local setup = reading_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-reading", setup.live and "live" or "unit")
...
function reading_direct_setup(mockres)
