...
describe("WordEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KANJI_DATA_TEST_WORD_ENTID JSON to run live")
      return
    end
...
function word_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KANJI_DATA_TEST_WORD_ENTID")
