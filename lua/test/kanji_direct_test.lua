...
describe("KanjiDirect", function()
  it("should direct-load-kanji", function()
    local setup = kanji_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-kanji", setup.live and "live" or "unit")
...
function kanji_direct_setup(mockres)
