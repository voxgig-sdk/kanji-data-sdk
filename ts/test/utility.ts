...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.KANJIDATA_TEST_LIVE ||
    'TRUE' === process.env.KANJIDATA_TEST_OVERRIDE
  ) {
  ...
  m.KANJIDATA_TEST_EXPLAIN = process.env.KANJIDATA_TEST_EXPLAIN || m.KANJIDATA_TEST_EXPLAIN
