...
(0, node_test_1.describe)('KanjiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-kanji', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-kanji', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KANJI_DATA_TEST_KANJI_ENTID'];
...
//# sourceMappingURL=KanjiDirect.test.js.map