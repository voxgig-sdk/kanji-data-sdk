...
(0, node_test_1.describe)('ReadingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'reading.' + op, live))
                return;
        }
        ...
        let reading_ref01_data = Object.values(setup.data.existing.reading)[0];
        // LOAD
        const reading_ref01_ent = client.Reading();
        const reading_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(reading_ref01_data_dt0.id === reading_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/reading/ReadingTestData.json');
    ...
    let idmap = transform(['reading01', 'reading02', 'reading03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ReadingEntity.test.js.map