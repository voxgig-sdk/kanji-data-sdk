...
(0, node_test_1.describe)('ReadingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KanjiDataSDK({
    ...
    (0, node_test_1.test)('direct-load-reading', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reading', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.KANJI_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KanjiDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KANJI_DATA_TEST_READING_ENTID'];
    ...
    const client = new __1.KanjiDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ReadingDirect.test.js.map