...
function envOverride(m) {
    if ('TRUE' === process.env.KANJI_DATA_TEST_LIVE ||
        'TRUE' === process.env.KANJI_DATA_TEST_OVERRIDE) {
    ...
    m.KANJI_DATA_TEST_EXPLAIN = process.env.KANJI_DATA_TEST_EXPLAIN || m.KANJI_DATA_TEST_EXPLAIN;
    return m;
}
