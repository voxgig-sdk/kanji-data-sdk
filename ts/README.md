# KanjiData TypeScript SDK



The TypeScript SDK for the KanjiData API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Kanji()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `KanjiDataSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `KanjiDataSDK.test(testopts?, sdkopts?)` | `KanjiDataSDK` | Create a test-mode client. |
...
| `client` | `client(): KanjiDataSDK` | Return the parent SDK client. |
...
kanji-data/
├── src/
│   ├── KanjiDataSDK.ts        # Main SDK class
