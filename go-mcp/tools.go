...
type Args struct {
	Entity string         `json:"entity" jsonschema:"kanji | reading | word"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KanjiDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kanji-data_list",
		Description: "List records from KanjiData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kanji-data_load",
		Description: "Load a single record from KanjiData. " +
...
func runOp(client *sdk.KanjiDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KanjiDataSDK, name string) (sdk.KanjiDataEntity, error) {
	switch strings.ToLower(name) {
	case "kanji":
		return client.Kanji(nil), nil
	case "reading":
		return client.Reading(nil), nil
	case "word":
