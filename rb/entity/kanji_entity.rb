...
class KanjiEntity
  ...
  # @return [Kanji, Hash] the current Kanji data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Kanji fields)
  def match_get
  ...
  # Load a single Kanji.
  #
  # @param reqmatch [KanjiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Kanji.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Kanji, Hash] the loaded Kanji; raises KanjiDataError on failure
