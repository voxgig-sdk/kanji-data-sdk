...
AQL-driven CLI and REPL for the KanjiData SDK. Positional arguments are
...
./kanji-data-cli list kanji
./kanji-data-cli load 1 kanji
./kanji-data-cli load '{id:1}' kanji
