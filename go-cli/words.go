...
func registerSDKWords(r *eng.Registry, client *sdk.KanjiDataSDK) {
...
func runOp(client *sdk.KanjiDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
